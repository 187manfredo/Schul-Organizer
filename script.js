// Daten
let faecherVorgabe=["Mathematik","Deutsch","Englisch","Französisch","Latein","Spanisch","Biologie","Chemie","Physik","Geschichte","Geographie","Politik / Sozialkunde","Musik","Kunst","Sport","Informatik / Computerwissenschaften","Philosophie / Ethik / Religion","Wirtschaft / Recht"];
let faecherHinzu=[];
let noten={};
...
// Dark Mode
document.getElementById("darkModeToggle").addEventListener("change",function(){ document.body.classList.toggle("dark",this.checked); });
